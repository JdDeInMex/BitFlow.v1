        ...
        <div className="footer-top">
          <div className="footer-brand">
            ...
            <p className="footer-tagline">
              The revolutionary Layer 0 infrastructure with infinite scalability
              and zero burns forever.
            </p>
          </div>
          ...
          <div className="footer-section">
            ...
            <ul className="footer-links">
              ...
              <li>
                <a href="#" onClick={(e) => { e.preventDefault(); handleNavigate('docs'); }}>
                  Documentation
                </a>
              </li>
              <li>
          ...
          <div className="footer-section">
            ...
            <div className="social-links">
              ...
              <a href="https://discord.gg/hyperlayer0" target="_blank" rel="noopener noreferrer" 
              ...
              <a href="https://github.com/hyperlayer0" target="_blank" rel="noopener noreferrer" 
